...
def get_tags_embeddings(text):
    ...
    similarities = {tag: cosine_similarity([article_embedding], [embedding])[0][0] for tag, embedding in
                    tag_embeddings.items()}
...
def get_subsector_embeddings(text):
    ...
    similarities_subsector = {subsector: cosine_similarity([article_embedding], [embedding])[0][0] for
                              subsector, embedding in subsector_embeddings.items()}
