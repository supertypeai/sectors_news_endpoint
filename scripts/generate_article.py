...
def generate_article_filings(pdf_url, sub_sector, holder_type, data, uid=None):
  ...
  article['share_percentage_transaction'] = float(article_info['share_percentage_transaction'].replace(",", ".").replace("%", "")) if len(article_info['share_percentage_transaction']) > 0 else 0.0
